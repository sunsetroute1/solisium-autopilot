...
1. Download the whole zip from [the v0.1.15 release](https://github.com/sunsetroute1/solisium-autopilot/releases/tag/v0.1.15), **or** clone this repo and run [`releases/assemble.cmd`](releases/assemble.cmd) to join the git-sized `.partNN` files.
...
Current build: **0.1.15** — download from the [v0.1.15 release](https://github.com/sunsetroute1/solisium-autopilot/releases/tag/v0.1.15) without building locally.
